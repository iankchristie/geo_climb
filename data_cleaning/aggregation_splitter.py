...
def split_csv_into_splits(csv_filepath: str):
    ...
    train_df.to_csv(Config.DATA_TRAINING_V4, index=False)
    val_df.to_csv(Config.DATA_VALIDATION_V4, index=False)
    test_df.to_csv(Config.DATA_TEST_V4, index=False)
    print("Data split into training.csv, validation.csv, and test.csv")


if __name__ == "__main__":
    split_csv_into_splits(Config.DATA_AGGREGATION_V4)
