...
DATA_DIR_UNLBL_EMBEDS=os.getenv("DATA_DIR_UNLBL_EMBEDS")
DATA_DIR_LBL_EMBEDS=os.getenv("DATA_DIR_LBL_EMBEDS")
...
class Config:
    ...
    DATA_DIR_UNLBL_EMBEDS=DATA_DIR_UNLBL_EMBEDS
    DATA_DIR_LBL_EMBEDS=DATA_DIR_LBL_EMBEDS